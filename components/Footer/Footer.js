    ...
    <div className={styles.menuContainer}>
      <div className={styles.leftmenuContainer}>
        ...
        <Paragraph>
          ...
          NFTs, you are sure to find the perfect option for your needs. The time
          is now. Let us help you find the perfect solution today!
        </Paragraph>
      </div>
      ...
      <div className={styles.menuLinksContainer}>
        ...
        {footerMenu.map((menu) => {
          return (
            <div className={styles.footerMenuItem} key={menu.name}>
